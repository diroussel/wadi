...
export const generateTargetEnvCmd: WadiCommandDef<{}, GenerateTargetEnvCliArgs> = {
  ...
  builder: {
    ...
    upload: {
      type: 'boolean',
      description: 'Flag to indicate if component zips should be uploaded to s3',
    },
    jsonOutput: {
      type: 'string',
      description:
    ...
    appPrefix: {
      type: 'string',
      description:
        'A path to a subsection of the repo, if you only want to find artifacts in this sub folder',
    },
  },
