...
export const generateOpenapi3VarmapCommand: WadiCommandDef<{}, GenerateOpenapi3VarMapCliArgs> = {
  command: 'generate-openapi3-varmap',
  describe: 'Generate terraform variables file for inputs to the lambda-openapi3 module',
  builder: {
    targetEnvJsonPath: {
      type: 'string',
